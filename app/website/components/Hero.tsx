        ...
        <div className="grid items-center gap-16 lg:grid-cols-[1.05fr_0.95fr]">
          ...
          <div className="max-w-2xl">
            ...
            <p className="mt-10 max-w-lg text-xl leading-relaxed text-white/75">
              Speak, converse, call and message across India's languages instantly.
            </p>
    ...
    <div className="flex justify-center lg:justify-end">
      ...
      <div className="relative">
        ...
        >
          ...
          {/* Language Selector */}
          <div className="mt-7 flex items-center justify-between rounded-2xl border border-zinc-800 bg-[#0D1222] p-4">
          ...
          <div className="mt-8">
            ...
            <div className="rounded-3xl bg-[#1747FF] p-5">
          ...
          <div className="mt-6">
            ...
            <div className="rounded-3xl border border-zinc-800 bg-[#0D1222] p-5">
